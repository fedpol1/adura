...
execute if score @s[tag=!adura.wentfrom] adura.page matches 4 run function adura:menu/gofrom/4
execute if score @s[tag=!adura.wentfrom] adura.page matches 5 run function adura:menu/gofrom/5
execute if score @s[tag=!adura.wentfrom] adura.page matches 6 run function adura:menu/gofrom/6
